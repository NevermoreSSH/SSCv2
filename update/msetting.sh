...
echo -e "$BLUE╠➣$NC 9$NC. Check CPU & RAM             $BLUE      ║ " 
echo -e "$BLUE╠➣$NC 10$NC. DNS Changer                $BLUE      ║ " 
echo -e "$BLUE╠➣$NC 11$NC. Netflix Checker            $BLUE      ║ " 
echo -e "$BLUE╠➣$NC 12$NC. ON/OF Auto Reboot          $BLUE      ║ " 
echo -e "$BLUE╠➣$NC 13$NC. Back to Menu               $BLUE      ║ " 
echo -e "$BLUE║---------------------------------------║"
echo -e "$BLUE╚═══════════════════════════════════════╝$NC"  
